...
using FACode.Core.Messages.Integration;
...
namespace FACode.Identidade.API.Controllers
{
    ...
    public class AuthController : MainController
    {
        ...
        private UsuarioRespostaLogin ObterRespostaToken(string encodedToken, User user,
            IEnumerable<Claim> claims)
        {
            return new UsuarioRespostaLogin
            {
                ...
                UsuarioToken = new UsuarioToken
                {
                    Id = user.Id,
                    Nome = user.Nome,
                    Responsabilidade = user.Responsabilidade,
                    Avatar = $"data:image/jpeg;base64,{user.Avatar.FromImageToString()}",
                    Email = user.Email,
